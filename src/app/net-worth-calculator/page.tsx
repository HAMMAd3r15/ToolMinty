    ...
    return (
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To get a complete picture of your financial health, enter your various 'Assets' (e.g., Savings, Property) and 'Liabilities' (e.g., Mortgage, Credit Cards). The tool instantly calculates your 'Total Assets', 'Total Liabilities', and your overall 'Net Worth' in vibrant, high-fidelity cards. You can update any item to see how changes in your portfolio impact your wealth in real-time."
                whyUse="Our Net Worth Calculator is a professional-grade wealth management utility designed for absolute transparency and financial mindfulness. It removes the complexity of personal balance sheets by providing a clean, stable interface for auditing your financial status. The 'elite' design features glassmorphic cards and crisp typography that make wealth tracking feel modern and premium. It is a completely free, privacy-focused resource where your personal financial data never leaves your device. Whether you're tracking quarterly progress or planning for the future, this tool delivers professional-level insights."
            />
        </div>
    );
}
