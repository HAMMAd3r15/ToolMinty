...
export default function WorkoutTracker() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Workout Progress Tracker"
                howToUse="To log your gains, enter the exercise name, weight used, and the number of sets and reps achieved. Click 'Log Workout' to instantly add the entry to your local high-fidelity table. The tool provides a premium visual summary of your lifting history, allowing you to track trends and ensure progressive overload with absolute precision. All logs are stored securely on your machine for future training sessions."
                whyUse="Our Workout Tracker is an 'elite' strength-training utility designed for dedicated lifters who demand a stable and sophisticated way to document their progress. It provides a reliable digital notebook experience that eliminates the need for messy paper logs or bloated apps. The high-fidelity interface features glassmorphism and a clean, responsive table design that makes data entry a premium experience. It is a completely free, privacy-focused resource where all your lifting history remains strictly private on your device."
            />
        </div>
    );
}
