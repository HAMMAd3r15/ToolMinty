    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To transform your text, paste your content into the input field and select your desired conversion mode (UPPERCASE, Title Case, camelCase, etc.). The tool instantly applies the selected logic and displays the result in a secondary action card. Use the 'Copy Result' button to quickly move your formatted text into your project. This automated process ensures consistency and absolute precision in your documents and code."
                whyUse="Our Text Case Converter is a professional-grade formatting utility designed for writers, programmers, and editors who demand a stable and efficient workflow. It offers more than just basic case changes, providing specialized formats like snake_case and camelCase with high-fidelity results. The 'elite' interface features a clean, responsive layout and glassmorphic elements that make text manipulation a premium experience. It is a free, privacy-focused tool that ensures your text remains secure by processing everything locally in your browser."
            />
        </div>
    );
}
