    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To find your Grade Point Average, enter your 'Course Name', select your 'Grade' from the high-fidelity dropdown, and enter the 'Credits' for each course. You can add as many courses as needed with the '+ Add Course' button. The tool instantly calculates your cumulative 'GPA' on a 4.0 scale and your 'Total Credits' in premium result cards."
                whyUse="Our GPA Calculator is a professional academic utility designed for absolute precision and long-term academic tracking. It removes the stress of grade weighting by providing a clear, stable, and 100% accurate calculation of your academic standing. The 'elite' design utilizes custom glassmorphic dropdowns and crisp typography that make academic management feel intuitive and superior. It is a completely free, privacy-focused resource where all your transcript data remains strictly local in your browser. Whether you're tracking your semester progress or preparing for graduation, this tool delivers the professional performance you need."
            />
        </div>
    );
}
