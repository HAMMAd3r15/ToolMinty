...
export default function WorkHourCalculator() {
    ...
    return (
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Work Hour Calculator"
                howToUse="To calculate your total shift time, select your 'Start Time' (clock-in) and 'End Time' (clock-out) using the 24-hour or AM/PM picker. Enter any 'Break' duration in minutes. The tool instantly computes your total 'Hours Worked' in a standard format (e.g., 8h 30m) and provides the 'Decimal Hours' (e.g., 8.50h), which is essential for payroll and timesheet entries. It also supports overnight shifts that cross midnight."
                whyUse="Our Work Hour Calculator is a professional-grade timesheet utility that removes the risk of manual math errors in payroll reporting. By automatically handling breaks and overnight shifts, it saves time for employees, freelancers, and small business owners alike. The addition of decimal hours ensures compatibility with accounting software, while the glassmorphic design provides a premium, distraction-free environment for managing your professional hours. It's 100% free, private, and works entirely in your browser."
            />
        </div>
    );
}
