...
export default function OvertimeCalculator() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Overtime Pay Calculator"
                howToUse="To calculate your total earnings, enter your 'Hourly Rate', 'Regular Hours', and 'Overtime Hours'. You can also adjust the 'OT Multiplier' (typically 1.5 for time-and-a-half). The tool instantly displays your 'Regular Pay', 'Overtime Pay', and 'Total Pay' in high-fidelity result cards. Adjust the hours or multiplier to see how different shifts impact your take-home pay in real-time."
                whyUse="Our Overtime Pay Calculator is a professional financial utility designed for absolute transparency and payroll accuracy. It removes the complexity of wage calculations by providing a clear, stable breakdown of your total earnings. The 'elite' design features glassmorphic panels and crisp typography that make income tracking feel intuitive and premium. It is a completely free resource that respects your privacy by processing all payroll data locally in your browser. Whether you're verifying your paycheck or planning for extra shifts, this tool delivers the professional insights you need."
            />
        </div>
    );
}
