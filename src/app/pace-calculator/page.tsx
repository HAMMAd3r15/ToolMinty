    ...
    return (
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To determine your running speed, input your finish time (hours, minutes, seconds) and the distance you covered. Select your preferred unit (km or miles) to see your pace per unit and average speed displayed in high-fidelity result cards. This automated calculation provides a stable baseline for race planning and training optimization with absolute precision."
                whyUse="Our Pace Calculator is an 'elite' athletic utility designed for runners, cyclists, and fitness enthusiasts who demand precision and a premium experience. It provides a stable and reliable way to analyze your performance across different distances and units without the need for manual math. The high-fidelity interface features glassmorphism and clear, responsive result zones that make data analysis feel as sophisticated as your training. It is a completely free, privacy-focused tool where all your technical measurements remain entirely secure on your device."
            />
        </div>
    );
}
