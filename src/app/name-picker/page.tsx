...
export default function NamePicker() {
    ...
    const calc = calculators.find(c => c.href === '/name-picker');

    return (
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            <ToolHeader
                title={calc?.title || 'Random Name Picker'}
                description={calc?.description || 'Enter a list of names and let the randomizer pick a winner instantly.'}
            />
