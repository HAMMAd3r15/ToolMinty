...
export default function ImageColorPicker() {
    ...
    const calc = calculators.find(c => c.href === '/color-picker');
    const faqs = [
    ...
    return (
        <div style={{ maxWidth: '750px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To extract colors from an image, upload any photo by clicking the drop zone, dragging and dropping a file, or pasting from your clipboard with Ctrl+V. Once your image loads, hover your mouse cursor over it to see a real-time preview tooltip showing the HEX color code. Click anywhere on the image to lock and save that exact color. Your selected HEX and RGB values appear in a dedicated result card below. You can build a palette of up to 8 saved colors by clicking different areas of the image."
                whyUse="Our Image Color Picker is a professional-grade design utility ideal for web designers, brand developers, and digital artists. Instead of guessing color values, it provides pixel-perfect HEX and RGB codes instantly from any image source. The 'elite' interface with real-time hover preview and a saved color palette makes it far more powerful than a standard color dropper. It is completely free, processes all images locally in your browser for total privacy, and requires no plugins or software installation."
            />
        </div>
    );
}
