...
export default function BabyNameGenerator() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Random Baby Name Generator"
                howToUse="To find the perfect name, select your preferred category — 'Boy', 'Girl', or 'Neutral' — using the toggle buttons at the top. Then click the large 'Generate Name' button to instantly reveal a beautiful, culturally diverse name displayed in a dramatic animated card. Keep clicking to explore hundreds of different options until you find the one that resonates with you. The tool draws from a massive curated list of modern, traditional, and multicultural names."
                whyUse="Our Random Baby Name Generator is designed for the thoughtful modern parent who wants creative inspiration without overwhelm. Unlike simple lists, our tool presents names one at a time in a premium animated reveal that makes the experience feel exciting and intuitive. The curated library spans global cultures and naming traditions, ensuring you discover unique, meaningful options you may not have considered. It's a completely free, privacy-focused tool where all selections happen locally — helping you find a name as unique as your little one."
            />
            <style jsx>{`
                @keyframes bounceIn {
