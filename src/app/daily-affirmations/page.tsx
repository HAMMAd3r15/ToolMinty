...
export default function DailyAffirmations() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Daily Affirmation Generator"
                howToUse="To begin your positive practice, simply arrive at the page and read the affirmation displayed prominently. If you'd like a different one, click the 'Next Affirmation' button to cycle through our library of over 90 hand-curated positive statements. Each affirmation covers a distinct life category, from self-worth and productivity to health, abundance, and relationships. Use the affirmation that resonates most with you as your personal mantra for the day by reading it aloud or repeating it mentally."
                whyUse="Our Daily Affirmation Generator is a mindfulness tool grounded in positive psychology and the science of neuroplasticity. Consistent use of positive self-talk helps re-wire neural pathways, building greater confidence and a more optimistic outlook over time. The 'elite' interface presents each affirmation in a stunning, full-screen gradient card that transforms a simple practice into a premium, intentional ritual. It is completely free, requires no account, and is the perfect companion for your morning routine, meditation, or journaling practice."
            />
            <style jsx>{`
