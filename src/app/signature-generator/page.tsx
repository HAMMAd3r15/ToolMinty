...
export default function SignatureGenerator() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Digital Signature Generator"
                howToUse="To create your signature, use your mouse or touch-screen device to draw directly on the white canvas. You can select your preferred 'Ink Color' using the color picker for a customized look. Once you are satisfied, click 'Download PNG' to save your signature with a professional-grade transparent background, ready to be overlaid on any digital document. If you need to restart, simply click 'Clear Canvas'."
                whyUse="Our Signature Generator is an 'elite' administrative utility designed for professionals who demand precision and privacy. It provides a stable and highly-responsive drawing experience that mimics physical ink on paper. The tool ensures that your signature remains entirely local—no data is ever sent to our servers—giving you absolute peace of mind for sensitive document handling. The premium interface and high-fidelity output make it the perfect resource for adding a personal touch to your digital workflow."
            />
