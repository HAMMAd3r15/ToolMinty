    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To estimate your healthy weight range, select your gender and preferred unit system (Metric or Imperial). Enter your height into the input field, and the tool will instantly calculate your 'ideal' weight using the clinically recognized Devine formula. The results are displayed for both kg and lbs in high-fidelity cards, providing a professional and stable baseline for your personal health goals. Results update in real-time as you switch units or adjust height, ensuring absolute accuracy and ease of use."
                whyUse="Our Ideal Weight Calculator is a premier health utility designed to provide clarity on body metrics without the confusion of complex charts. By leveraging standard clinical formulas, it offers a reliable and stable estimate that helps you set realistic health and wellness targets. The 'elite' user interface features glassmorphic design elements and responsive action zones that make calculating your health data feel premium and sophisticated. It is a completely free, privacy-focused resource where all your personal biometric data remains entirely secure within your browser."
            />
        </div>
    );
}
