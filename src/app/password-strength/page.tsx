    ...
    return (
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To check your password security, simply type or paste any password into the input field. The tool instantly analyzes it against six security criteria: minimum length (8 chars), strong length (12 chars), uppercase letters, lowercase letters, numbers, and special characters. A color-coded strength bar visually represents the overall score from 'Very Weak' to 'Very Strong', while a checklist shows you exactly which criteria you're passing or failing."
                whyUse="Our Password Strength Checker is the safest way to evaluate any password because it is 100% client-side — your password is never transmitted to any server. The detailed criteria checklist gives you actionable feedback on exactly how to strengthen any password, unlike tools that only give a score. The premium visual strength meter with glow effects provides an intuitive and immediate understanding of your security level. It's completely free, instant, and requires no account."
            />
        </div>
    );
}
