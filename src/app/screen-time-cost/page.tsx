...
export default function ScreenTimeCost() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Screen Time Cost Calculator"
                howToUse="To reveal the true impact of your habits, enter your 'Daily Screen Time' in hours and optionally your 'Hourly Rate'. The tool instantly calculates your 'Hours per Year' and 'Hours per Month' wasted, displayed in high-fidelity result cards. If you provided a wage, it also computes the total 'Opportunity Cost' in currency. This automated analysis provides a stable look at how digital consumption affects your productivity and potential income."
                whyUse="Our Screen Time Cost Calculator is an 'elite' lifestyle utility designed for individuals who strive for absolute time-awareness and financial efficiency. It moves beyond simple tracking to offer a tangible cost-benefit analysis of your digital life. The premium interface features glassmorphism and responsive data visualizations that make self-reflection a sophisticated and impactful experience. It is a free, privacy-focused tool where your habits and income data remain strictly local on your device."
            />
        </div>
    );
}
