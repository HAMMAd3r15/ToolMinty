    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To find your score, enter your 'Earned Points' and the 'Total Possible Points'. The tool instantly calculates your 'Percentage' and assigns a 'Letter Grade' based on a standard 10-point scale. The result is displayed in a high-fidelity card with color-coded feedback. You can adjust the points to see what score you need for your target grade with absolute precision."
                whyUse="Our Grade Calculator is a professional academic utility designed for absolute clarity and stress-free score tracking. It removes the need for manual percentage math by providing a clear, stable, and 100% accurate assessment of your performance. The 'elite' design utilizes glassmorphism and crisp typography that make academic planning feel intuitive and premium. It is a completely free, privacy-focused resource where all your grades are processed locally in your browser. Whether you're checking an exam result or tracking course progress, this tool delivers the professional performance you need."
            />
        </div>
    );
}
