    ...
    return (
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To start a session, click 'Start' to begin the default 25-minute Pomodoro. When the timer ends, switch to 'Short Break' (5 min) and start again. After four complete Pomodoros, take a 'Long Break' (15 min). Use the ⚙ settings icon to customize all three durations to fit your workflow. Completed sessions are tracked with dots below the timer, helping you visualize your deep work streaks."
                whyUse="Our Pomodoro Timer is a precision productivity tool that helps you enter and sustain a state of deep focus by structuring your work into proven, cognitively-optimized intervals. Browser notifications alert you when sessions end, so you never have to watch the clock. The beautiful, distraction-free interface with a large time display and color-coded modes creates a premium focus environment. It is completely free, works entirely in your browser, and requires no sign-up or installation."
            />
