...
export default function HabitStreakCounter() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Habit Streak Counter"
                howToUse="To visualize your habit consistency, set your 'Period' in days (e.g., 30 for a month, 90 for a quarter) and adjust the 'Estimated Consistency' slider to reflect your actual adherence percentage. The tool instantly calculates how many 'Days Won' and 'Days Missed' that represents, and displays a visual grid of colored squares where each lit square represents a day you followed through. It's a powerful visual reminder of your progress."
                whyUse="Our Habit Streak Counter uses the behavioral science of visual progress tracking — seeing your 'wins' displayed in a GitHub-style activity grid creates a powerful psychological incentive not to break the chain. The dynamic calculation of Days Won vs. Days Missed gives you a clear, honest picture of your real consistency. It's a completely free, privacy-safe mindset tool to help you stay motivated on any 21-day, 66-day, or 90-day habit challenge."
            />
        </div>
    );
}
