    ...
    return (
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To generate a random base color, click '✨ New Base Color'. Then click '🎨 Generate Palette' to create a 5-color harmony based on your chosen mode from the panel on the right. Select from Random, Monochromatic, Analogous, Complementary, or Triadic harmony modes. Click any color in the palette to copy its HEX code, use the 🔒 lock icon to pin favorites, and click 🎯 to set a palette color as your new base for even more exploration."
                whyUse="Our Random Color Generator is a professional-grade design utility built for designers, developers, and artists who need harmonious color palettes fast. Instead of guessing which colors work together, the harmony engine generates mathematically perfect color relationships every time. The 'elite' interface lets you lock and explore colors interactively, creating custom palettes in seconds. It is completely free, privacy-focused, and processes everything locally in your browser."
            />
