...
export default function GoalPlanner() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Goal Breakdown Planner"
                howToUse="To transform a big ambition into reality, enter your 'Big Goal' and select a target 'Deadline'. Click 'Generate Breakdown' to instantly create a high-fidelity timeline of five key milestones: Research, Foundations, Halfway Point, Final Polish, and Launch. The tool calculates exact target dates for each phase, providing a stable roadmap that keeps you on track with absolute precision."
                whyUse="Our Goal Planner is an 'elite' strategy utility designed for high-achievers who understand the power of incremental progress. It removes the 'overwhelm' of large projects by automatically applying professional breakdown logic to any objective. The premium interface features glassmorphism and a responsive vertical timeline that makes tracking your journey feel modern and sophisticated. It is a completely free, privacy-focused tool where all your future plans are processed locally and securely in your browser."
            />
        </div>
    );
}
