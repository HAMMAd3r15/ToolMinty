...
export default function RandomWorkoutGenerator() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Random Workout Generator"
                howToUse="To generate your personalized workout plan, first select your 'Intensity' from Easy (3 exercises) to Hard (7 exercises), then choose a 'Focus Area' such as Full Body, Upper Body, Lower Body, or Core. Click the '⚡ Generate Workout' button to reveal your customized routine. Each exercise is displayed with the recommended rep count or time, making it ready to use immediately. You can regenerate as many times as you like to keep your training fresh."
                whyUse="Our Random Workout Generator removes the #1 barrier to daily exercise: decision fatigue. By instantly creating a structured, bodyweight-friendly routine, it makes starting your workout simple and effortless. The curated exercise library covers all major muscle groups, and the intensity levels are calibrated for both beginners and advanced athletes. The premium interface with animated exercise cards delivers a gym-app quality experience, completely free, with no account or subscription required."
            />
