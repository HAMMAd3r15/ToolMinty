...
export default function StudyTimetable() {
    ...
    return (
        <div style={{ maxWidth: '940px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Study Timetable Generator"
                howToUse="To create a professional daily schedule, enter your 'Subjects' (comma-separated), your 'Start' and 'End' times, and your preferred 'Session Length'. You can even specify a 'Lunch Time' and duration. Click 'Generate Timetable' to instantly produce a high-fidelity weekly grid. Click on any day to see a detailed, hour-by-hour breakdown include short and long breaks for maximum retention and focus."
                whyUse="Our Study Timetable Generator is an 'elite' academic utility that implements advanced interval-study techniques automatically. It provides a stable and highly-organized structure that eliminates the guesswork from your daily routine. The premium interface features a sophisticated 'Swimlane' visualization with a custom color palette for each subject, making your educational roadmap both beautiful and functional. It is a completely free, privacy-focused tool where your entire schedule is generated and stored locally in your browser."
            />
