    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To generate a secure key, use the slider to select your desired 'Password Length' and toggle the complexity options (Uppercase, Numbers, Symbols). Click 'Generate New Password' to instantly create a high-entropy string, which appears in a premium result card. Use the 'Copy' button to securely move your new password into your manager or application with absolute precision and ease."
                whyUse="Our Password Generator is a professional-grade security utility designed to help you create high-fidelity, random passwords that are extremely hard to crack. It provides a stable and reliable way to ensure your digital life is protected by unique keys tailored to your exact requirements. The 'elite' user interface features glassmorphic design elements and responsive feedback that make security management feel premium and sophisticated. It is a completely free, privacy-focused tool that guarantees your passwords are never stored or transmitted, as everything is generated locally in your browser."
            />
        </div>
    );
}
