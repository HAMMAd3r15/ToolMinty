...
export default function RandomQuoteGenerator() {
    ...
    return (
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 1rem' }}>
            ...
            <EliteSEOCards
                toolName="Random Quote Generator"
                howToUse="To receive a new dose of inspiration, click the 'Refresh Inspiration' button. A new quote from our curated library of over 100 motivational and philosophical quotes will appear with a smooth, elegant animation. The quotes span a wide range of sources including historical figures, athletes, business leaders, and even beloved fictional characters. You can share any quote you find resonant on social media or use it as a daily mantra."
                whyUse="Our Random Quote Generator is a premium motivational resource designed for the modern, purpose-driven individual. The curated library is carefully selected for depth, impact, and relevance across themes of success, resilience, creativity, and mindset. The 'elite' presentation features a dramatic glassmorphic card with a cinematic quote reveal animation that makes each reading feel meaningful and intentional. It is completely free, requires no account, and is a perfect way to start your day with a burst of perspective."
            />
