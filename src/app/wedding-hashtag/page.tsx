...
export default function WeddingHashtagGenerator() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Wedding Hashtag Generator"
                howToUse="To generate your personalized wedding hashtags, enter both partners' names in the 'Partner 1 Name' and 'Partner 2 Name' fields, and optionally add your wedding year. Click 'Generate Wedding Tags' to instantly produce 8 unique hashtag variations. Each tag is displayed in a clickable card — simply tap any hashtag to automatically copy it to your clipboard. Then paste it into your wedding invitations, website, or social media bio."
                whyUse="Our Wedding Hashtag Generator creates unique, personal social media identifiers in seconds, perfect for collecting all your guests' photos under one searchable tag. A custom hashtag brings all the candid moments, stories, and memories from your special day into one beautiful digital album. The tool automatically generates 8 creative variations combining both names and the year, meaning no two couples will ever have the same hashtag. It's completely free and requires no sign-up."
            />
        </div>
    );
}
