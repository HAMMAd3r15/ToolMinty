    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To create your perfect profile, enter your name, occupation, and a few hobbies separated by commas. Select a tone—such as 'Professional', 'Creative', or 'Funny'—that matches your platform and click 'Generate Bio'. The tool will instantly craft a stunning digital introduction that highlights your best qualities in a high-fidelity card. You can click 'Copy Bio' to immediately transfer the text to your clipboard for use on Instagram, TikTok, or Twitter. This simple process makes refreshing your online presence effortless and professional."
                whyUse="Our Bio Generator is a creative utility designed to help you solve the challenge of crafting a compelling digital first impression in seconds. Instead of struggling with writer's block, our tool uses curated templates and intelligent placeholders to provide high-quality bios that professionalize your social profiles. The 'elite' user interface offers a glassmorphic design with interactive tone selectors that make the creative process feel premium and streamlined. It is a free, privacy-focused resource that helps you maintain a consistent and impactful brand across all digital platforms without any hassle."
            />
        </div>
    );
}
