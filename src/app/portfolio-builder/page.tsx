...
export default function PortfolioBuilder() {
    ...
    return (
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Simple Portfolio Builder"
                howToUse="To build your portfolio card, fill in your 'Full Name', 'Job Title', 'About Me', and 'Skills' in the editor panel on the left. You can also upload a profile picture. The live preview on the right updates in real-time as you type. Once you're happy with your design, click 'Copy as Image' to capture it to your clipboard, ready to paste into any email, social profile, or document."
                whyUse="Our Simple Portfolio Builder enables anyone to create a professional digital presence in under a minute, without any coding or design skills. The live preview system gives you instant visual feedback, and the 'Copy as Image' feature makes sharing effortless. The premium dark-mode design with gradient accents and skill-tag chips creates a first impression that reflects modern, high-quality personal branding. It is completely free, with all data processed privately in your browser."
            />
