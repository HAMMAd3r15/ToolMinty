...
export default function GroceryList() {
    ...
    return (
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Grocery List Builder"
                howToUse="To build your list, type an item name in the main input field, adjust the quantity using the +/- buttons, and select a category from the dropdown (e.g., Produce, Dairy, Meat). Press 'Add' or hit Enter to add the item. Your list is automatically organized by category in a visual card layout. When done, click '⬇️ Download List as PNG' to save a beautiful, printable image of your full grocery list."
                whyUse="Our Grocery List Builder is a powerful organizational tool that eliminates the inefficiency of unstructured shopping. By automatically grouping items by store department, it maps out the most logical path through any supermarket, cutting your shopping time significantly. The 'Download as PNG' feature produces a professional, shareable image that's perfect for sending to family or printing. It's completely free, works offline in your browser, and keeps all your data private."
            />
        </div>
    );
}
