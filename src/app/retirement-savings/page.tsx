...
export default function RetirementSavingsCalculator() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Retirement Savings Goal"
                howToUse="To determine your target retirement nest egg, enter your 'Desired Annual Income' in retirement. Optionally, add your 'Current Age' and 'Planned Retirement Age' for more context. The tool uses the professional 25x rule to instantly display your 'Retirement Goal' and the estimated monthly savings needed (excluding interest) in high-fidelity cards."
                whyUse="Our Retirement Savings Goal calculator is a professional-grade financial planner designed to simplify the path to financial independence. It uses established industry standards like the 25x rule to provide a stable, 100% accurate baseline for your long-term goals. The 'elite' design features glassmorphic result panels and clean typography that make retirement planning feel clear and premium. It is a completely free resource that respects your privacy by processing all numbers locally. Whether you are just starting your career or nearing retirement, this tool provides the professional clarity you need."
            />
        </div>
    );
}
