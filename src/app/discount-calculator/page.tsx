    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To find your total savings, enter the 'Original Price' of the item and the 'Discount Percentage' (e.g., 20%). You can optionally add a 'Sales Tax' percentage to see the final post-tax price. The tool instantly calculates your final price, the total amount you save, and the tax amount in high-fidelity cards. Results are updated in real-time as you type, allowing you to quickly compare different sale scenarios with ease."
                whyUse="Our Discount Calculator is a professional-grade shopping utility designed for absolute precision during sales and clearance events. Unlike mental math, this tool provides a stable, 100% accurate calculation that includes tax considerations, ensuring no surprises at the register. The 'elite' design features glassmorphic result panels and optimized typography that look stunning on any mobile device. It is a completely free resource that respects your privacy by processing all numbers locally. Whether you're a bargain hunter or a retail professional, this tool delivers the professional performance you need."
            />
        </div>
    );
}
