...
export default function StudyPlanner() {
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                toolName="Study Time Planner"
                howToUse="To allocate your revision time effectively, enter the 'Total Study Hours' you have available. Add your subjects and assign each a difficulty weight from 1 (easy) to 3 (hard). The tool instantly calculates a high-fidelity distribution of hours for each subject, displayed in premium result cards. You can add or remove subjects in real-time to see how your schedule adjusts with absolute precision."
                whyUse="Our Study Time Planner is an 'elite' educational utility designed for students who value data-driven academic optimization. It provides a stable and objective way to balance your workload, ensuring you give the most attention to your most challenging topics. The premium user interface features glassmorphim and responsive design tokens that make exam preparation feel controlled and sophisticated. It is a free, privacy-focused resource where all your academic preferences are processed locally on your device."
            />
        </div>
    );
}
