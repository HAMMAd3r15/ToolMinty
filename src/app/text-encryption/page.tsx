    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <EliteSEOCards
                ...
                howToUse="To secure or reveal a message, enter your text into the main field and use the slider to select your 'Shift Value' or key. Click 'Encrypt' to transform your message into a secret code, or 'Decrypt' using the same key to read it back. The result is displayed in a specialized high-fidelity card with mono-spaced typography, providing a professional and stable way to explore classic cipher logic."
                whyUse="Our Text Encryption Tool is an 'elite' educational utility designed to make cryptography accessible and engaging. While it focuses on the classic Caesar Cipher, it provides a stable and reliable platform for understanding secret keys and string manipulation. The premium user interface features glassmorphism and high-fidelity slider controls that make learning about security feel sophisticated and modern. It is a completely free, privacy-focused resource that ensures your creative messages remain entirely secure on your local device."
            />
        </div>
    );
}
